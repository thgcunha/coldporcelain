        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mb-8">
            <img
              src={logo}
              alt="Cold Porcelain"
              className="w-24 h-24 rounded-full object-cover shadow-medium mx-auto"
            />
          </div>

          <h2 className="font-display text-4xl md:text-5xl font-semibold text-foreground mb-6">
            Pronta para criar sua <span className="text-primary">peça única</span>?
          </h2>
          
          <p className="font-sans text-lg text-muted-foreground mb-4 max-w-xl mx-auto">
            Entre em contato conosco! Envie sua inspiração, conte sua ideia e vamos 
            juntos transformar em realidade.
          </p>
          
          <p className="font-sans text-sm text-muted-foreground/80 mb-10">
            Orçamento sem compromisso • Resposta rápida • Atendimento personalizado
          </p>
